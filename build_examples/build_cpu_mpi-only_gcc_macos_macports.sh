...
sed -i '' -e "s#<CCFLAGS>#${CCFLAGS}#g" Makefile
sed -i '' -e "s#<POT3D_CUSPARSE>#${POT3D_CUSPARSE}#g" Makefile
sed -i '' -e "s#<HDF5_INCLUDE_DIR>#${HDF5_INCLUDE_DIR}#g" Makefile
sed -i '' -e "s#<HDF5_LIB_DIR>#${HDF5_LIB_DIR}#g" Makefile
sed -i '' -e "s#<HDF5_LIB_FLAGS>#${HDF5_LIB_FLAGS}#g" Makefile
echo "Building POT3D...."
